...
pdf_path_label = tk.Label(root,text=" Convert Pdf file to Word file ", font=("Arial",32),bg="cyan")
...
pdf_path_button = tk.Button(root, text="Select File", command=select_file, font=font,bg="IndianRed")
...
convert_button = tk.Button(root, text="Convert to Word", command=convert_pdf_to_word, font=font,bg="IndianRed")
